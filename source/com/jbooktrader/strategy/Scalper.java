...
public class Scalper extends Strategy {
    ...
    public Scalper(StrategyParams params, MarketBook marketBook) throws JBookTraderException {
        super(marketBook);
        ...
        entry = params.get(ENTRY, 0.2);
        exit = params.get(EXIT, 0);
