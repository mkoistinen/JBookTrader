 ...
 *
 */
public class SecondNature1 extends StrategyES {
    ...
    public void setParams() {
        addParam(FAST_PERIOD, 1, 30, 1, 18);
        addParam(SLOW_PERIOD, 600, 2000, 100, 960);
        addParam(TREND_PERIOD, 100, 900, 10, 460);
        addParam(ENTRY, 80, 160, 1, 118);
    }
