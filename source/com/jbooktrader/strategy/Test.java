 ...
 *
 */
public class Test extends StrategyES {
    ...
    public void setParams() {
        addParam(FAST_PERIOD, 3, 25, 1, 11);
        addParam(SLOW_PERIOD, 600, 1800, 5, 2200);
        addParam(TREND_PERIOD, 270, 600, 5, 270);
        addParam(ENTRY, 110, 140, 1, 100);
    }
